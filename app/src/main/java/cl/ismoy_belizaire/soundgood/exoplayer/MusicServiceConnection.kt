...
import cl.ismoy_belizaire.soundgood.other.Event
...
class MusicServiceConnection(private val context: Context) {
   ...
   private val mediaBrowser =MediaBrowserCompat(
    ...
    private inner class MediaBrowserConnectionCallback(context: Context) : MediaBrowserCompat.ConnectionCallback(){
